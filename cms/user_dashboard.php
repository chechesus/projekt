...
<head>
    ...
    <script src="../notifications/notif_refresh.js"></script> <!-- Fetch notifications using JavaScript -->
...
<body>
    ...
    <div id="notifications">
        <ul id="notificationList"></ul> --><!-- Dynamic notifications will be loaded here --> <!--
    </div>
    <main>
        <h2>Your Comments</h2>
        <form id="commentForm">
        ...
        <div id="commentsSection"></div> --><!-- Dynamic comments will be loaded here --> <!--
    </main>-->
    ...
    <nav class="app-header navbar navbar-expand bg-body"> <!--begin::Container-->
        ...
        <aside class="app-sidebar">
            <?php require_once '../website_elements/sidebar-menu/index.php'; ?>
        </aside>
    ...
    <script>
        // Handle comment submission dynamically
        document.getElementById('commentForm').addEventListener('submit', function(e) {
            e.preventDefault();
            const comment = document.getElementById('comment').value;

            // AJAX request to send comment
            fetch('../api/send_comment.php', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                ...
                commentsSection.innerHTML += `<p>${data.comment}</p>`;
